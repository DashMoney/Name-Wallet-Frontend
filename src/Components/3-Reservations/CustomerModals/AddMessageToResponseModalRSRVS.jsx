...
class AddMessageToResponseModalRSRVS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = () => {
    this.props.editResponseAddMessage_RSRVS(this.state.commentInput);
    this.props.hideModal();
  };
...
export default AddMessageToResponseModalRSRVS;
