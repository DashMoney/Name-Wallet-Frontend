...
class Pay2PartyRequestModalRSRVS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.payDash2PartyRequest_RSRVS(this.state.commentInput);
...
export default Pay2PartyRequestModalRSRVS;
