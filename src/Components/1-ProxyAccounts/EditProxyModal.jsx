...
class EditProxyModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      identityInput: this.props.selectedProxyTuple[0],

      validLabel: true,
      tooLongLabelError: false,
      labelInput: this.props.selectedProxyTuple[1],
    };
  }
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.editProxyController(proxyTuple);
    this.props.hideModal();
  };
  ...
  render() {
    ...
    let editedProxyList = [...this.props.ProxyController.proxyList];

    editedProxyList.splice(this.props.selectedProxyTupleIndex, 1);

    let isIdentityDuplicate = true;
    let isLabelDuplicate = false;

    if (this.state.identityInput !== "") {
      let identityFound = editedProxyList.find((tuple) => {
    ...
    if (this.state.labelInput !== "") {
      let labelFound = editedProxyList.find((tuple) => {
          ...
          <Modal.Body>
            ...
            >
              <Form.Group className="mb-3" controlId="formIdentity">
                ...
                <Form.Control
                  type="text"
                  defaultValue={this.props.selectedProxyTuple[0]}
                  required
                  isInvalid={this.state.wrongLengthError}
                  isValid={this.state.validIdentity}
                />
                <p></p>
    ...
    isLabelDuplicate  */}
              ...
              <Form.Group className="mb-3" controlId="formLabel">
                ...
                <Form.Control
                  type="text"
                  defaultValue={this.props.selectedProxyTuple[1]}
                  required
