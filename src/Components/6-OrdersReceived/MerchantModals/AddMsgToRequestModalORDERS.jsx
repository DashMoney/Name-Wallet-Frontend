...
class AddMsgToRequestModalORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = () => {
    this.props.editRequestAddMessage_ORDERS(this.state.commentInput);
    this.props.hideModal();
  };
...
export default AddMsgToRequestModalORDERS;
