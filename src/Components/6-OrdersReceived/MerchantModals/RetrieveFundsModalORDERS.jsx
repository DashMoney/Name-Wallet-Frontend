...
class RetrieveFundsModalORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.payRetrieveFunds_ORDERS(this.state.commentInput);
...
export default RetrieveFundsModalORDERS;
