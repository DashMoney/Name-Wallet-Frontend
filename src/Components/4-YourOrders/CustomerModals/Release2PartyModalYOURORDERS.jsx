...
class Release2PartyModalYOURORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.editReleaseFunds_YOURORDERS(this.state.commentInput);
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <Modal.Header>
            <Modal.Title>Release 2-Party Funds</Modal.Title>
            {closeButtonColor}
          </Modal.Header>
          <Modal.Body>
            {/* <h6>
            ...
            <>
              {this.state.loadTime >= 1 ? (
                <Button variant="primary" disabled>
                  <b>Release Funds ({this.state.loadTime})</b>
                </Button>
              ) : (
...
export default Release2PartyModalYOURORDERS;
