...
class WithdrawRefundModalYOURORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.payWithdrawRefund_YOURORDERS(this.state.commentInput);
...
export default WithdrawRefundModalYOURORDERS;
