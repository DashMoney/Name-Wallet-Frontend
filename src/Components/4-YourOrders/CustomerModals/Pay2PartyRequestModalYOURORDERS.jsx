...
class Pay2PartyRequestModalYOURORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.payDash2PartyRequest_YOURORDERS(this.state.commentInput);
...
export default Pay2PartyRequestModalYOURORDERS;
