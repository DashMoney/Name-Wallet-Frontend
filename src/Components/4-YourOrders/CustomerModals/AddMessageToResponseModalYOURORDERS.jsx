...
class AddMessageToResponseModalYOURORDERS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = () => {
    this.props.editResponseAddMessage_YOURORDERS(this.state.commentInput);
    this.props.hideModal();
  };
...
export default AddMessageToResponseModalYOURORDERS;
