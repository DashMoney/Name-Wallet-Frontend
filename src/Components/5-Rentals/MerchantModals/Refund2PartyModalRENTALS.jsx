...
class Refund2PartyModalRENTALS extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = (event) => {
    ...
    this.props.editRefundFunds_RENTALS(this.state.commentInput);
...
export default Refund2PartyModalRENTALS;
