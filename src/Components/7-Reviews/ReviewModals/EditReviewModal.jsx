...
class EditReviewModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: this.props.reviewToEdit.review, //SO A COMMENT IS NOT REQUIRED -> OKAY
      validComment: true,
      tooLongCommentError: false,

      selectedStars: this.props.reviewToEdit.rating, // 0 - 5 and controlled by radio boxes <- special case handle like other modals do switches <- yes
    };
  }
            ...
            >
              ...
              <Form.Group className="mb-3" controlId="formComment">
                ...
                <Form.Control
                  ...
                  as="textarea"
                  rows={3}
                  defaultValue={this.props.reviewToEdit.review}
                  required
