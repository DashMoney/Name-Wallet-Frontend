...
class AddMessageToResponseModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = () => {
    this.props.editResponseAddMessage(this.state.commentInput);
    this.props.hideModal();
  };
...
export default AddMessageToResponseModal;
